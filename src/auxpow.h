...
/* Because it is needed for auxpow, the definition of CMerkleTx is moved here from wallet.h  */
...
public:
     ...
     * we do not care in the Alaris client how the auxpow is constructed
     * by a miner.
     */
...
public:
    ...
    */
    inline uint256 getParentBlockHash() const {
